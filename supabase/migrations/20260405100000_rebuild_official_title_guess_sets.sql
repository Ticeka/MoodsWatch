-- ============================================================
-- Rebuild official Party Title Guess sets
-- 2026-04-05
--
-- Goal:
-- - remove legacy official sets
-- - rebuild one official anime-wide set from catalog data only
-- - keep user-created sets untouched
-- - use clue order:
--   1. least important / tail-end side character
--   2. lower-ranked supporting character
--   3. earlier / stronger side character
--   4. protagonist or heroine
-- ============================================================
...
begin
  ...
  values (
    ...
    'Official auto-generated anime-wide question set built from the catalog character ranking data.',
    'public',
    true
  )
  ...
  with seeded_questions as (
    ...
    join (
      ...
      where c1.character_id <> c2.character_id
        ...
        and c2.character_id <> c4.character_id
        and c3.character_id <> c4.character_id
    ) candidate on candidate.answer_title_id = q.answer_title_id
